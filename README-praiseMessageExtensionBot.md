# Praise Message Extension Bot - `praiseMessageExtensionBot`
...
3. Give the bot a handle (ex: `praiseMessageExtensionBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://praise.azurewebsites.net/api/messages`
